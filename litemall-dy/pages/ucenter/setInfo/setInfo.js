...
Page({
  ...
  submintUserInfo(data, msg) {
    let userInfos = tt.getStorageSync('userInfo');
    ...
    tt.setStorageSync('userInfo', userInfos);
  ...
  onReady() {
    ...
    this.setData({
      "userInfo.birthday": tt.getStorageSync('userInfo').birthday,
      "userInfo.birthdayValue": new Date(tt.getStorageSync('userInfo').birthday).getTime(),
      "userInfo.nickName": tt.getStorageSync('userInfo').nickName,
      "userInfo.sex": tt.getStorageSync('userInfo').gender == "1" ? "男" : "女",
      "userInfo.mobile": tt.getStorageSync('userInfo').mobile,
      "userInfo.headUrl": tt.getStorageSync('userInfo').avatarUrl
    });
  },

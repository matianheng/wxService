...
module.exports = {
  ...
  AuthGetHeadPture: WxApiRoot + 'auth/getHeadPture', //获取头像列表

  AuthUpdateUserInfoPture: WxApiRoot + 'auth/updateUserInfoPture', //更新用户详细信息
  ...
  AuthLogout: WxApiRoot + 'auth/logout', //获取图片列表
